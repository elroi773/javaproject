...
<body>
	...
	<div class = "active">
		<a href = "main.jsp">메인</a>
	        ...
	        <div class="login-container">
			        <h1 class="login-title">대신 전해드립니다</h1>
			        <form id="loginForm" class="logout-form">
			            <input type="text" id="username" placeholder="아이디" class="logput-input">
			            <input type="password" id="password" placeholder="비밀번호" class="logout-input">
			            <button type="button" onclick="submitLogin()" class="logout-button" href = "LogoutAction.jsp">로그아웃</button>
			        </form>
		    </div>
	        <%
	        	}
